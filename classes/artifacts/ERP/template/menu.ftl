    ...
    <ul class="nav navbar-nav side-nav" style="height: 100%">
        ...
        <li>
            ...
            <ul id="hrm_dd" class="collapse">
                <li><a href="/IsCool/hrm/userDetailsList.cool">User</a></li>
                <li><a href="/IsCool/hrm/createDepartment.cool">Department</a></li>
                <li><a href="/IsCool/hrm/createDesignation.cool">Designation</a></li>
